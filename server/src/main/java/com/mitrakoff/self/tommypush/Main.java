...
public class Main {
    public static void main(String[] args) {
        ...
        // Samsung Galaxy S7
        final String fcmTokenSamsung = "d2-l9NbZSJ6s9jBkLXo_Ya:APA91bGat-LFN7OAMjTwgAKu8wm7_wzK7DmUU0__PnuDzIqgEP5909HUqHjItZNabVTyrYFtzkZKK1fMgd2KXnJIGGXkrTc9Ofeyhm3smQouCcPglq3u9TzRpw_wieA52Gv1MgTODLaJ";
        // Nelly
        final String fcmTokenNelly = "cOlSdL6IRHK1iPQK-gYq3-:APA91bFb3SQepLl0epysO219nmH9eNGHx2moNRqs5RnzIYP0eicCJNlmwSAR6U8A6Lvx7G6BzzRVQFKnA_RXXH-N5LWxWvFqvTzfAGAt88ed9B4XKeppEPenKoFsF322-HOsjlZMihpy";
        // iPhone X
        final String fcmTokenX = "e5BOi9E7Gk9JhyKDCP2bNy:APA91bHLj9FoQRZKfHH0UGMA8ChP1TuZ7R1abYpkTv65arx__oUsBZfFyKRA3yQ7VrEJCFDOGLb5NKvuICAAiNEXePzvRm-Ig1FkIxFjAuvZckPmiixlruZxo8p5KnQ9XLe2O2ZttlGQ";
        ...
        final List<Checker> checkers = List.of(
            ...
            //new Checker("Aviasales", "POST", aviasalesPath, Optional.of(aviasalesJson()), "data.best_prices_v2.cheapest_direct.value", new LessComparer(), desiredAviasalesRate, firebase, List.of(fcmTokenX))
        );
